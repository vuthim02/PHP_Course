<?php
// order.php — order confirmation page (Phase 4).
include __DIR__ . "/layout/header.php";
?>

<div class="amz-order-confirm">
  <div class="amz-check-circle">&#10004;</div>
  <h1>Thank you, your order is confirmed</h1>
  <p>Order <strong>#<?php echo (int) $order["id"]; ?></strong> &mdash;
     placed on <?php echo e(date("F j, Y g:i A", strtotime($order["created_at"]))); ?>.</p>
  <span class="amz-status"><?php echo strtoupper(e($order["status"])); ?></span>
</div>
...
<div class="amz-checkout-layout">
  ...
  <aside class="amz-order-summary">
    ...
    <a class="amz-btn amz-btn-yellow" href="/products">Continue shopping</a>
  </aside>
</div>
